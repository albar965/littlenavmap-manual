...
**Si no obtiene los resultados esperados o no obtiene ningún resultado, utilice el elemento de menú `Borrar todos los filtros de búsqueda`, el botón ![Reset Search](../images/icons/clear.png "Reset Search") o presionar `Ctrl+R` para limpiar todos los criterios de búsqueda.**
...
* **Seleccionada:** Debe de coincidir con la condición.
* **Casilla vacía:** No debe de coincidir con la condición.
...
_**Imagen superior con una búsqueda compleja de escenario:** Este ejemplo muestra cómo encontrar escenarios añadidos específicos mediante el uso del campo _`Ruta de escenario`_ . Muestra todos los aeropuertos del escenario complementario Orbx New Zealand South Island que tienen pistas iluminadas.
...
Utilice `Shift+Click` o `Ctrl+Click` para selecciona dos o más elementos (multi-selección).
...
Muestre una ayuda rápida en el menú emergente. Haga clic para abrir ese capítulo del manual en el navegador predeterminado.
...
### Menú contextual con la vista de tabla de resultados {#search-result-table-view-context-menu}

Los elementos del menú disponibles dependen de la pestaña de búsqueda.

#### ![Show Information](../images/icons/globals.png "Show Information") Muestra información {#show-information-0}

Lo mismo que [Menú contextual de Mapa](MAPDISPLAY.md#map-context-menu).
...
#### ![Set Center for Distance Search](../images/icons/mark.png "Set Center for Distance Search") Restablece el centro de la distancia de búsqueda {#set-center-for-distance-search-0}
